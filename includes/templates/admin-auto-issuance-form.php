...
<div class="accredible-wrapper">
	...
	<div class="accredible-content">
		<form
			action="admin.php?page=accredible_learndash_admin_action&<?php echo $accredible_learndash_form_action; ?>"
			method="post">
				...
				<div class="accredible-form-field">
					<label for="accredible_learndash_credential_group"><?php esc_html_e( 'Select the credential group' ); ?></label>
				</div>
